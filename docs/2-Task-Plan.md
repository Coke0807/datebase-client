...
- [x] 3.4.1 搜索项目中所有使用 `scopedSlots` 的组件
- [x] 3.4.2 替换为 `v-slot` 语法
- [x] 3.4.3 搜索项目中所有使用 `filters` 的组件
- [x] 3.4.4 替换为 `computed` 属性或方法（未发现使用）
- [x] 3.4.5 搜索项目中所有使用 `Element UI` 组件的代码
- [x] 3.4.6 替换为 `Element Plus` 组件（组件名无变化）
- [x] 3.4.7 迁移 `src/vue/App.vue` 根组件
- [x] 3.4.8 迁移 `src/vue/connect/` 下的所有组件
- [x] 3.4.9 迁移 `src/vue/design/` 下的所有组件
- [x] 3.4.10 迁移 `src/vue/forward/` 下的所有组件
- [x] 3.4.11 迁移 `src/vue/i18n/` 下的所有组件
- [x] 3.4.12 迁移 `src/vue/redis/` 下的所有组件
- [x] 3.4.13 迁移 `src/vue/result/` 下的所有组件
- [x] 3.4.14 迁移 `src/vue/status/` 下的所有组件
- [x] 3.4.15 迁移 `src/vue/structDiff/` 下的所有组件
- [x] 3.4.16 迁移 `src/vue/util/` 下的所有组件
- [x] 3.4.17 迁移 `src/vue/xterm/` 下的所有组件

### 3.5 阶段 3 验证

- [x] 3.5.1 运行 `npm run build` 确认构建成功
- [ ] 3.5.2 手动测试扩展加载功能
